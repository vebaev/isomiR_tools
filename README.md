...
|QuickMIRSeq|Linux|
● Quantify miRNAs and isomiRs<br/>
● Avoid of multiple mapping issue of reads of identical sequences<br/>
● Clustering and grouping of identical and similar sequences<br/>
● Trimming adapters, collapsing, joint mapping with Bowtie<br/>
● Remapping reads with mismatches to a reference genome to further reduce the number of false hits|
|2017
|Shanrong Zhao et all.
