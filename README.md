...
|-----------|--------|---------------|------|---------|-------------|-------------|--------------|
| miRMaster | Web | ● Quantification of miRNAs and non-coding RNAs<br/>  ● Discovering of new miRNAs and isomiRs | 2017 | Tobias Fehlmann et all. | Nucleic Acids Research | Open Access |
| | | | | | https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5587802/10.1093/nar/gkx595 | 10.1093/nar/gkx595 |
